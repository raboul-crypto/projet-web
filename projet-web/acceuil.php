...
<section class="info-section-container" style="display: flex; flex-direction: column; gap: 30px; margin-top: 30px;">
    ...
    <div class="stat-card-compact" style="background-color: var(--secondary-color); color: var(--text-light); padding: 30px; border-radius: var(--border-radius); text-align: center;">
    ...
    <div class="history-module-small" style="background-color: var(--card-bg); border: 1px solid var(--border-color); border-radius: var(--border-radius); padding: 30px; box-shadow: var(--shadow-card);">
        <div class="history-header">
            <span class="history-tag" style="color: var(--accent-color); font-weight: bold; font-size: 0.8rem; letter-spacing: 1px;">HISTOIRE DE L'EFREI</span>
